...
class FreeVerbDsp : public FaustDsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow7 = (iConst10 + iSlow6);
		int iSlow8 = (iConst7 + iSlow6);
		int iSlow9 = (iConst9 + iSlow6);
		int iSlow10 = (iConst8 + iSlow6);
		int iSlow11 = (iConst5 + iSlow6);
		int iSlow12 = (iConst3 + iSlow6);
		int iSlow13 = (iConst4 + iSlow6);
		int iSlow14 = (iConst6 + iSlow6);
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp7 = ((0.5f * fRec30[1]) + (fRec32[0] + (fRec34[0] + (fRec36[0] + (fRec38[0] + (fRec40[0] + ((fRec42[0] + fRec44[0]) + fRec46[0])))))));
			...
			float fTemp10 = ((0.5f * fRec24[1]) + (fRec27 + fRec26[1]));
