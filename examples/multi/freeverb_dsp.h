...
Compilation options: -lang cpp -ct 1 -cn FreeVerbDsp -scn fausty::FaustDsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FreeVerbDsp : public fausty::FaustDsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("author", "RM");
		m->declare("compile_options", "-lang cpp -ct 1 -cn FreeVerbDsp -scn fausty::FaustDsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst3 = static_cast<int>(0.025306122f * fConst0);
		iConst4 = std::max<int>(0, iConst3 + -1);
		iConst5 = static_cast<int>(0.026938776f * fConst0);
		iConst6 = std::max<int>(0, iConst5 + -1);
		iConst7 = static_cast<int>(0.028956916f * fConst0);
		iConst8 = std::max<int>(0, iConst7 + -1);
		iConst9 = static_cast<int>(0.030748298f * fConst0);
		iConst10 = std::max<int>(0, iConst9 + -1);
		iConst11 = static_cast<int>(0.0322449f * fConst0);
		iConst12 = std::max<int>(0, iConst11 + -1);
		iConst13 = static_cast<int>(0.033809524f * fConst0);
		iConst14 = std::max<int>(0, iConst13 + -1);
		iConst15 = static_cast<int>(0.035306122f * fConst0);
		iConst16 = std::max<int>(0, iConst15 + -1);
		iConst17 = static_cast<int>(0.036666665f * fConst0);
		iConst18 = std::max<int>(0, iConst17 + -1);
		iConst19 = static_cast<int>(0.0126077095f * fConst0);
		iConst20 = std::min<int>(1024, std::max<int>(0, iConst19 + -1));
		iConst21 = static_cast<int>(0.01f * fConst0);
		iConst22 = std::min<int>(1024, std::max<int>(0, iConst21 + -1));
		iConst23 = static_cast<int>(0.0077324263f * fConst0);
		iConst24 = std::min<int>(1024, std::max<int>(0, iConst23 + -1));
		iConst25 = static_cast<int>(0.0051020407f * fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = 0.1f * fSlow0;
		float fSlow3 = fConst1 * static_cast<float>(fVslider1);
		float fSlow4 = 1.0f - fSlow3;
		float fSlow5 = fConst2 * static_cast<float>(fVslider2) + 0.7f;
		int iSlow6 = static_cast<int>(fConst27 * static_cast<float>(fVslider3)) + -1;
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output1[i0] = static_cast<FAUSTFLOAT>(fRec25 + fRec24[1] + fSlow1 * fTemp1);
			fRec9[1] = fRec9[0];
			IOTA0 = IOTA0 + 1;
			fRec8[1] = fRec8[0];
			fRec11[1] = fRec11[0];
