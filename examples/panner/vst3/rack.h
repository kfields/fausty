...
//-----------------------------------------------------------------------------
class Rack : public Vst::AudioEffect
{
public:
	Rack ();
...
//------------------------------------------------------------------------
	...
	static FUnknown* createInstance (void*) { return (Vst::IAudioProcessor*)new Rack (); }
...
protected:
	...
	tresult (Rack::*processAudioPtr) (Vst::ProcessData& data);
